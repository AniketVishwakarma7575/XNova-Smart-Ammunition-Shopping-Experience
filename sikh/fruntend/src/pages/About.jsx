    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-24">
          ...
          >
            <h1 className="text-4xl sm:text-5xl text-black md:text-6xl font-extrabold leading-tight">
              Born to Move — Built for Performance
            </h1>
            <p className="mt-4 text-lg text-black sm:text-xl text-black/90">
              At Waprn Shop, we redefine modern luxury with effortless style and confidence.
              Every piece is crafted with precision — blending premium quality, bold design, and timeless appeal.
              From casual streetwear to statement essentials, Waprn Shop empowers a new generation to express who they are, unapologetically.
            </p>

            <div className="mt-6 flex gap-3">
              <Link
                to="/shop"
                className="inline-flex items-center gap-3 border-black/90 bg-white text-black px-5 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition"
              >
                Shop Latest
                <svg
              ...
              <a
                href="#story"
                className="inline-flex items-center text-black gap-2 px-5 py-3 rounded-full border border-black/30  hover:bg-white/10 transition"
              >
                Our Story
              </a>
            </div>
      ...
      {/*  MISSION & VALUES */}
      <section id="story" className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              ...
              At Waprn Shop, we create fashion that blends modern trends, sustainable fabrics,
              and everyday affordability — helping you express your style with confidence.
            </p>

            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <li className="flex items-start gap-3">
                <span className="inline-flex items-center justify-center h-10 w-10 rounded-lg bg-black text-white font-semibold">
                  1
                </span>
                <div>
                  <h4 className="font-semibold">Innovation</h4>
                  <p className="text-sm text-gray-600">
                    Constant R&D for lighter, stronger, faster gear.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Reducing waste and using recycled materials where possible.
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <div className="flex-none w-12 h-12 rounded-full bg-black text-white grid place-items-center font-semibold">
                  {m.year}
                </div>
                <div>
      ...
      <section className="bg-black text-white py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h4 className="text-xl font-bold">Ready to Move?</h4>
          ...
          <Link
            to="/"
            className="inline-block bg-white text-black px-5 py-3 rounded-full font-semibold shadow hover:scale-105 transition"
          >
            Shop Now
          </Link>
        </div>
